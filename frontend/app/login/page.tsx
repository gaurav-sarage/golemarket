                ...
                <div className="w-full max-w-md mx-auto">
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <p className="text-gray-500">
                            ...
                            <Link href="/register" className="font-bold text-primary-600 hover:text-primary-500 underline decoration-primary-600/30 underline-offset-4 transition-all">
                                Create one today
                            </Link>
                        </p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link href="/forgot-password" className="text-sm font-bold text-primary-600 hover:text-primary-500 transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative">
                    ...
                    <div className="mt-10 pt-6 border-t border-gray-100 flex flex-col gap-4">
                        <Link href="/seller/login" className="w-full h-12 flex items-center justify-center px-4 text-sm font-bold rounded-xl text-gray-600 bg-white border-2 border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all">
