                    ...
                    {shops.map((shop: any, i) => (
                        ...
                        >
                            ...
                            <div className="p-5 flex-1 flex flex-col">
                                ...
                                <Link
                                    href={`/shops/${shop._id}`}
                                    className="mt-6 w-full flex justify-between items-center py-2.5 px-4 rounded-xl bg-primary-50 text-primary-700 font-semibold hover:bg-primary-600 hover:text-white transition-all"
                                >
